...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public int carné;
    public static pasajero pasajero1;
    @Override
    ...
    public void showinfo(View view) {
        ...
        texto.setText("Calificación: " + pasajero1.getNota());
        texto = (TextView) findViewById(R.id.textView);
        texto.setText("Carné: " + pasajero1.getCarné());
    }
    ...
    public class ScannerActivity implements ZXingScannerView.ResultHandler{
        ...
        public void handleResult(Result result) {
            ...
            setContentView(R.layout.activity_main);
             pasajero1.setCarné(Integer.parseInt(dato));
            camara.stopCamera();
        }
    }
